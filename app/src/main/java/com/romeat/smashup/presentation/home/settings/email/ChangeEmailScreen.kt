    ...
    Surface(
        ...
        if (viewModel.state.showSuccessScreen) {
            InfoScreen(
                ...
                titleResId = R.string.confirm_new_email,
...
fun ChangeEmailScreenContent(
    ...
    Column(
        ...
        TopRow(
            title = stringResource(R.string.email_change_title),
        ...
        Column(
            ...
            TextBody1(resId = R.string.email_change_info)
