...
import com.romeat.smashup.domain.user.profile.ConfirmUsernameUpdateUseCase
...
@HiltViewModel
class ConfirmUsernameViewModel @Inject constructor(
    private val savedStateHandle: SavedStateHandle,
    private val confirmUsernameUpdateUseCase: ConfirmUsernameUpdateUseCase
) : ViewModel() {
